...
uci set wireless.@wifi-device[2].country='CN'
uci set wireless.@wifi-device[2].txpower='20'
...
uci set wireless.@wifi-iface[2].ssid='OpenWrt_2.4G'
uci del wireless.@wifi-iface[2].key
